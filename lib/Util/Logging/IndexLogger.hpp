...
enum class IndexSettingsColumn {
    ...
    PARAM_ESTIMATOR_CONFIG_GEN_TYPE,  // Type of config generator used for the parameter estimator, if applicable
    PARAM_ESTIMATOR_NUM_CONFIGS,      // Number of configurations used for the parameter estimator
