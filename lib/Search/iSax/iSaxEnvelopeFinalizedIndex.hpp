...
class iSaxEnvelopeFinalizedIndex : public IFinalizedEnvelopeIndex {
   public:
     ...
     */
    iSaxEnvelopeFinalizedIndex(unsigned segment_len, unsigned series_len, vec<vec<iSaxWord>> first_isax_mins,
   ...
   private:
    ...
    MAKE_SERIALIZABLE((m_segment_len, m_series_len, m_first_sax_mins, m_first_sax_maxs, m_first_layer_nodes,
                       m_first_layer_num_bits, m_alphabet_num_bits, m_num_seg_per_channel, m_num_channels,
                       m_breakpoints));
};
