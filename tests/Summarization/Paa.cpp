...
TEST_CASE("PAA happy-flow works") {
    ...
    vec<Real> expected = {1.5, 3.5, 5.5, 7.5, 9.5};
...
TEST_CASE("get_paa_entries_normalized works") {
    ...
    vec<vec<Real>> uts = {{3, 7, 1.2, 3.7, 9.1, -3.5, -1.5, 0, 0.8}};
    vec<IndexEntry<Paa>> entries = generator.get_entries(uts, 0);
    vec<IndexEntry<Paa>> expected = {
        {{0, 0, 4}, {{{0.00396971, 0, 0}}}},       {{0, 0, 5}, {{{-0.373683, 0, 0}}}},
        {{0, 1, 4}, {{{-0.423736, 0, 0}}}},        {{0, 0, 6}, {{{0.0782954, -0.0782955, 0}}}},
        {{0, 1, 5}, {{{0.105442, 0, 0}}}},         {{0, 2, 4}, {{{0.449213, 0, 0}}}},
        {{0, 0, 7}, {{{0.247292, 0.0936011, 0}}}}, {{0, 1, 6}, {{{0.292186, -0.292186, 0}}}},
        {{0, 2, 5}, {{{0.653408, 0, 0}}}},         {{0, 3, 4}, {{{0.235, 0, 0}}}},
        {{0, 1, 7}, {{{0.397995, -0.217601, 0}}}}, {{0, 2, 6}, {{{0.779816, -0.779816, 0}}}},
        {{0, 3, 5}, {{{0.346383, 0, 0}}}},         {{0, 4, 4}, {{{0.0708175, 0, 0}}}},
        {{0, 2, 7}, {{{0.867058, -0.813973, 0}}}}, {{0, 3, 6}, {{{0.409657, -0.409657, 0}}}},
        {{0, 4, 5}, {{{0.089585, 0, 0}}}},         {{0, 5, 4}, {{{-0.376514, 0, 0}}}},
    };
