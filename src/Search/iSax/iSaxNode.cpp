...
vec<UlisseEnvelope> iSaxInternalNode::get_envelopes() const { return {}; }
...
vec<UlisseEnvelope> iSaxLeaf::get_envelopes() const { return {}; }

SaxSplitIndT iSaxLeaf::get_split_ind() const { return -1; }
