...
EnvStatsChSegmentationStrategy::EnvStatsChSegmentationStrategy(
    uptr<IndexStatsScoreFunc> index_stats_score_func, uptr<IScoreToSegmentationStrategy> score_to_segmentation_strategy,
    SamplingChSSSamplingParams sampling_params)
    : ScoreBasedChSegmentationStrategy(std::make_unique<EnvelopeStatsScores>(std::move(index_stats_score_func)),
